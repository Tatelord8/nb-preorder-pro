// Script completamente nuevo para verificar backups de Supabase
...
console.log('📋 Total de claves:', sessionStorageKeys.length);
...
const cartCookies = allCookies.filter(cookie => 
...
const domCartElements = document.querySelectorAll('[data-cart], [data-carrito], [id*="cart"], [class*="cart"]');
console.log('🔍 Elementos relacionados con carrito:', domCartElements.length);
