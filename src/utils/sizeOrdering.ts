...
export function sortSizesByOrder(sizes: string[], genero: string): string[] {
  ...
  const sizeOrders: Record<string, string[]> = {
    ...
    // Womens: 5 … 10 con medios (5 y 5.5 aplican a CAT, el resto a NB)
    'Womens': ['5', '5.5', '6', '6.5', '7', '7.5', '8', '8.5', '9', '9.5', '10'],
    
    // Unisex calzados: 4 … 12 con medios
    'Unisex': ['4', '4.5', '5', '5.5', '6', '6.5', '7', '7.5', '8', '8.5', '9', '9.5', '10', '10.5', '11', '11.5', '12'],
